...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__12447){
var map__12448 = p__12447;
var map__12448__$1 = cljs.core.__destructure_map(map__12448);
var request = map__12448__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12448__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__12452 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__12452.cljs$core$IFn$_invoke$arity$1 ? fexpr__12452.cljs$core$IFn$_invoke$arity$1(response) : fexpr__12452.call(null, response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__12453 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__12453.cljs$core$IFn$_invoke$arity$1 ? fexpr__12453.cljs$core$IFn$_invoke$arity$1(response) : fexpr__12453.call(null, response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__12454){
var map__12455 = p__12454;
var map__12455__$1 = cljs.core.__destructure_map(map__12455);
var request = map__12455__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12455__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
