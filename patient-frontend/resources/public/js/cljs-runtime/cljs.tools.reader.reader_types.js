...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_21056 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_21056(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_21061 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_21061(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21065 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21065(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21067 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21067(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21068 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21068(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21069 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21069(reader);
}
});
...
var G__21102 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__21103 = s.append(c);
c = G__21102;
s = G__21103;
continue;
}
