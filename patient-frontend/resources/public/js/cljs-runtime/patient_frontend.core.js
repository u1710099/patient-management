...
var patient = cljs.core._nth(c__5478__auto__,i__11989);
cljs.core.chunk_append(b__11990,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.Keyword("patients","full_name","patients/full_name",75837196).cljs$core$IFn$_invoke$arity$1(patient),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__11989,patient,c__5478__auto__,size__5479__auto__,b__11990,s__11988__$2,temp__5804__auto__,patients_data){
return (function (){
return cljs.core.reset_BANG_(patient_frontend.core.current_patient,patient);
});})(i__11989,patient,c__5478__auto__,size__5479__auto__,b__11990,s__11988__$2,temp__5804__auto__,patients_data))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__11990),patient_frontend$core$patient_list_$_iter__11987(cljs.core.chunk_rest(s__11988__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__11990),null);
}
} else {
var patient = cljs.core.first(s__11988__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.Keyword("patients","full_name","patients/full_name",75837196).cljs$core$IFn$_invoke$arity$1(patient),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (patient,s__11988__$2,temp__5804__auto__,patients_data){
return (function (){
return cljs.core.reset_BANG_(patient_frontend.core.current_patient,patient);
});})(patient,s__11988__$2,temp__5804__auto__,patients_data))
], null),"Edit"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (patient,s__11988__$2,temp__5804__auto__,patients_data){
return (function (){
return patient_frontend.core.delete_patient(new cljs.core.Keyword("patients","id","patients/id",1962288166).cljs$core$IFn$_invoke$arity$1(patient));
});})(patient,s__11988__$2,temp__5804__auto__,patients_data))
], null),"Delete"], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("patients","id","patients/id",1962288166).cljs$core$IFn$_invoke$arity$1(patient)], null)),patient_frontend$core$patient_list_$_iter__11987(cljs.core.rest(s__11988__$2)));
}
} else {
return null;
}
