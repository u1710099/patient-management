...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22206 = c;
var G__22206__$1 = (((G__22206 == null))?null:G__22206.prototype);
if((G__22206__$1 == null)){
return null;
} else {
return G__22206__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22208 = c;
var G__22208__$1 = (((G__22208 == null))?null:G__22208.prototype);
if((G__22208__$1 == null)){
return null;
} else {
return G__22208__$1.render;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__22286 = c;
...
var _STAR_current_component_STAR__orig_val__22293 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22294 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22294);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22293);
}});
...
var c = this;
var G__22319_22412 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__22319_22412 == null)){
} else {
reagent.ratom.dispose_BANG_(G__22319_22412);
}
...
var renders_22416 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22417 = cljs.core.first(cljs.core.vals(renders_22416));
...
if((cljs.core.count(renders_22416) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22416))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22417)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22417], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__22341 = o;
reagent.impl.component.goog$module$goog$object.set(G__22341,cljs.core.name(k),v);
...
return (function() { 
var G__22423__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__22424__i < G__22424__a.length) {G__22424__a[G__22424__i] = arguments[G__22424__i + 0]; ++G__22424__i;}
  args = new cljs.core.IndexedSeq(G__22424__a,0,null);
} 
return G__22423__delegate.call(this,args);};
G__22423.cljs$lang$maxFixedArity = 0;
G__22423.cljs$lang$applyTo = (function (arglist__22425){
var args = cljs.core.seq(arglist__22425);
return G__22423__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__22372 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22373 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22373);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22372);
}});
...
var vec__22375 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22375,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22375,(1),null);
...
var G__22379 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__22379 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22379);
}
});
}),[]);
