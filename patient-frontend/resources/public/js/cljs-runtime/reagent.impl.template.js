...
return (function() { 
var G__22759__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__22759 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__22760__i = 0, G__22760__a = new Array(arguments.length -  0);
while (G__22760__i < G__22760__a.length) {G__22760__a[G__22760__i] = arguments[G__22760__i + 0]; ++G__22760__i;}
  args = new cljs.core.IndexedSeq(G__22760__a,0,null);
} 
return G__22759__delegate.call(this,args);};
G__22759.cljs$lang$maxFixedArity = 0;
G__22759.cljs$lang$applyTo = (function (arglist__22761){
var args = cljs.core.seq(arglist__22761);
return G__22759__delegate(args);
});
...
var G__22664 = o;
reagent.impl.template.goog$module$goog$object.set(G__22664,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__22763__i < G__22763__a.length) {G__22763__a[G__22763__i] = arguments[G__22763__i + 0]; ++G__22763__i;}
  args = new cljs.core.IndexedSeq(G__22763__a,0,null);
} 
...
var G__22743 = props;
var G__22743__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22743,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22743);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22743__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22744 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22744,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22744;
}
})(),id_class);
...
var G__22745 = (cljs.core.count(argv) - first_child);
switch (G__22745) {
case (0):
...
var vec__22746 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22746,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22746,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22746,(2),null);
...
var temp__5808__auto___22766 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22766 == null)){
} else {
var key_22767 = temp__5808__auto___22766;
(jsprops.key = key_22767);
}
...
var temp__5808__auto___22768 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22768 == null)){
} else {
var key_22769 = temp__5808__auto___22768;
...
var temp__5808__auto___22770 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___22770 == null)){
} else {
var key_22771 = temp__5808__auto___22770;
...
var temp__5808__auto___22772 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22772 == null)){
} else {
var key_22773 = temp__5808__auto___22772;
(jsprops.key = key_22773);
}
...
var temp__5808__auto___22774 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22774 == null)){
} else {
var key_22775 = temp__5808__auto___22774;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22749_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22749_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22750 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22750,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22750,(1),null);
...
break;
default:
var G__22777 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22778 = compiler;
v = G__22777;
compiler = G__22778;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22756 = (function (opts,id,fn_to_element,parse_fn,meta22757){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22756.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22758,meta22757__$1){
var self__ = this;
var _22758__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22756(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22757__$1));
}));

(reagent.impl.template.t_reagent$impl$template22756.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22758){
var self__ = this;
var _22758__$1 = this;
return self__.meta22757;
}));

(reagent.impl.template.t_reagent$impl$template22756.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22756.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22756.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22756.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22756.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22756.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22757","meta22757",29426438,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22756.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22756.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22756");

(reagent.impl.template.t_reagent$impl$template22756.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template22756");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22756.
 */
reagent.impl.template.__GT_t_reagent$impl$template22756 = (function reagent$impl$template$__GT_t_reagent$impl$template22756(opts,id,fn_to_element,parse_fn,meta22757){
return (new reagent.impl.template.t_reagent$impl$template22756(opts,id,fn_to_element,parse_fn,meta22757));
});
...
return (new reagent.impl.template.t_reagent$impl$template22756(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
