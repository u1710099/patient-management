...
var G__20423 = o;
reagent.impl.template.goog$module$goog$object.set(G__20423,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__20789__delegate = function (args){
...
while (G__20790__i < G__20790__a.length) {G__20790__a[G__20790__i] = arguments[G__20790__i + 0]; ++G__20790__i;}
  args = new cljs.core.IndexedSeq(G__20790__a,0,null);
} 
return G__20789__delegate.call(this,args);};
...
return G__20789__delegate(args);
});
...
var G__20438 = o;
reagent.impl.template.goog$module$goog$object.set(G__20438,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__20460 = props;
var G__20460__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20460,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__20460);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20460__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__20462 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20462,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__20462;
}
})(),id_class);
...
var G__20475 = (cljs.core.count(argv) - first_child);
switch (G__20475) {
case (0):
...
var vec__20499 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20499,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20499,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20499,(2),null);
...
var temp__5808__auto___20802 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___20802 == null)){
} else {
var key_20803 = temp__5808__auto___20802;
(jsprops.key = key_20803);
}
...
var temp__5808__auto___20804 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___20804 == null)){
} else {
var key_20805 = temp__5808__auto___20804;
(jsprops.key = key_20805);
}
...
var temp__5808__auto___20806 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___20806 == null)){
} else {
var key_20807 = temp__5808__auto___20806;
(jsprops.key = key_20807);
}
...
var temp__5808__auto___20808 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___20808 == null)){
} else {
var key_20809 = temp__5808__auto___20808;
(jsprops.key = key_20809);
}
...
var temp__5808__auto___20810 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___20810 == null)){
} else {
var key_20811 = temp__5808__auto___20810;
(jsprops.key = key_20811);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20671_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__20671_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__20700 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20700,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20700,(1),null);
...
break;
default:
var G__20822 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__20823 = compiler;
v = G__20822;
compiler = G__20823;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template20740 = (function (opts,id,fn_to_element,parse_fn,meta20741){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template20740.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20742,meta20741__$1){
var self__ = this;
var _20742__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template20740(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta20741__$1));
}));

(reagent.impl.template.t_reagent$impl$template20740.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20742){
var self__ = this;
var _20742__$1 = this;
return self__.meta20741;
}));

(reagent.impl.template.t_reagent$impl$template20740.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template20740.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template20740.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template20740.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template20740.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template20740.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta20741","meta20741",-1986343465,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template20740.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template20740.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template20740");

(reagent.impl.template.t_reagent$impl$template20740.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template20740");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template20740.
 */
reagent.impl.template.__GT_t_reagent$impl$template20740 = (function reagent$impl$template$__GT_t_reagent$impl$template20740(opts,id,fn_to_element,parse_fn,meta20741){
return (new reagent.impl.template.t_reagent$impl$template20740(opts,id,fn_to_element,parse_fn,meta20741));
});
...
return (new reagent.impl.template.t_reagent$impl$template20740(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
