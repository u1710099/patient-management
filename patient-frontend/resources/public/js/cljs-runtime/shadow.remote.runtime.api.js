...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13963 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13963(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_13968 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_13968(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_13969 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_13969(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_13972 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_13972(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13975 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13975(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13982 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13982(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__13955,callback){
var map__13956 = p__13955;
var map__13956__$1 = cljs.core.__destructure_map(map__13956);
var input = map__13956__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13956__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13956__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
